...
ymax_all = 1.1 * max(max(Ndata));
    ...
    if figure_save == 1
        ...
        file_name = strcat(projectionname(j), '_spaghetti.png');
...
fig_name_2 = "_spaghetti_by_phase_ma";
...
%% --------------------------------
%% Projection-specific phase summary tables (compact layout)
%% --------------------------------

% ===================== AB 3-2 =====================
begin_table_simple(fid, 'AB 3-2 projection accuracy by phase', 'lD{.}{.}{-1}D{.}{.}{-1}c');
fprintf(fid,'\n Projection horizon & \\multicolumn{1}{c}{Bias(\\%%)} & \\multicolumn{1}{c}{RMSE(\\%%)} & \\multicolumn{1}{c}{N} \\\\');
fprintf(fid,'\n \\hline');
...
% ===================== AB 3-3 =====================
begin_table_simple(fid, 'AB 3-3 projection accuracy by phase', 'lD{.}{.}{-1}D{.}{.}{-1}c');
fprintf(fid,'\n Projection horizon & \\multicolumn{1}{c}{Bias(\\%%)} & \\multicolumn{1}{c}{RMSE(\\%%)} & \\multicolumn{1}{c}{N} \\\\');
fprintf(fid,'\n \\hline');
...
% ===================== Fujii-Nakata =====================
begin_table_simple(fid, 'Fujii-Nakata projection accuracy by phase', 'lD{.}{.}{-1}D{.}{.}{-1}c');
fprintf(fid,'\n Projection horizon & \\multicolumn{1}{c}{Bias(\\%%)} & \\multicolumn{1}{c}{RMSE(\\%%)} & \\multicolumn{1}{c}{N} \\\\');
fprintf(fid,'\n \\hline');
...
% ===================== Hirata =====================
begin_table_simple(fid, 'Hirata projection accuracy by phase', 'lD{.}{.}{-1}D{.}{.}{-1}c');
fprintf(fid,'\n Projection horizon & \\multicolumn{1}{c}{Bias(\\%%)} & \\multicolumn{1}{c}{RMSE(\\%%)} & \\multicolumn{1}{c}{N} \\\\');
fprintf(fid,'\n \\hline');
...
% ===================== CATs =====================
begin_table_simple(fid, 'CATs projection accuracy by phase', 'lD{.}{.}{-1}D{.}{.}{-1}c');
fprintf(fid,'\n Projection horizon & \\multicolumn{1}{c}{Bias(\\%%)} & \\multicolumn{1}{c}{RMSE(\\%%)} & \\multicolumn{1}{c}{N} \\\\');
fprintf(fid,'\n \\hline');
...
%% --------------------------------
begin_table_simple(fid, 'Weighted average projection accuracy by phase across projections', 'lD{.}{.}{-1}D{.}{.}{-1}c');
fprintf(fid,'\n Projection horizon & \\multicolumn{1}{c}{Bias(\\%%)} & \\multicolumn{1}{c}{RMSE(\\%%)} & \\multicolumn{1}{c}{N} \\\\');
fprintf(fid,'\n \\hline');
